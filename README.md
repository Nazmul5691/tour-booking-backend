...
This backend powers the **Dream Tour** platform, handling tours,
bookings, guides, payments, reviews, and admin analytics.
...
The system follows **modular architecture**, **role-based access
control**, and **clean service-controller separation**.
